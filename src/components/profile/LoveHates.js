...
const LoveHates = (props) => {
  ...
  loveHateObject.isHated
    ? (buttonClass = "closeButtonColor")
    : (buttonClass = "closeButtonColor");
  ...
  const fetchMovieFromTMDB = () => {
    mAPI.searchWithId(props.movieObject.dbid).then((res) => {
        ...
        <div className="card movieCard shadow">
          <div onClick={toggle}>
            ...
            <CardImg
              ...
              top
              src={imageHandler()}
              alt={`${fetchedMovieObject.title} poster`}
              className="cardImage"
            />
            <CardTitle className="loveHateTitle">
              {fetchedMovieObject.title}
            </CardTitle>
            <CardBody>
              <Modal isOpen={modal} toggle={toggle} className="modalModel">
                ...
                <ModalBody>
                  <MovieDetails
                    ...
                    movieObject={fetchedMovieObject}
                    dbid={fetchedMovieObject.id}
                  />
                  <Comment
